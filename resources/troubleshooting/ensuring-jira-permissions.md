...
Released adheres to Jira permissions for viewing and editing issues. Therefore, your Jira Space permission settings determine what you can do and see in Released.
...
\
If a Space is hidden from Released using App Access rules, you won't be able to interact with it in Released. Add Released to your allowlist or remove it from your blocklist to use Released with your protected Jira Spaces.
{% endhint %}

### Required Jira Space permissions
...
<table><thead><tr><th width="219">Permission</th><th>Required for</th></tr></thead><tbody><tr><td><strong>Administer Spaces</strong></td><td>Setting up the <strong>Changelog description</strong> custom field.</td></tr><tr><td><strong>Jira administrators</strong></td><td>Installing the Released App.</td></tr></tbody></table>
...
1. You don't have the [Edit issues](https://support.atlassian.com/jira-cloud-administration/docs/permissions-for-company-managed-projects/#Issue-permissions) permission for that Space. If this is the case, speak to the Space administrator about obtaining edit access to that Space.
