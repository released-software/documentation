---
description: Hub is available for Jira Cloud via the Atlassian Marketplace.
icon: circle-down
...
You must have **Administer Jira** global permission to enable Hub in your Jira site.
...
To install **Hub** via the Atlassian Marketplace, follow these steps:
...
To install **Hub** on your Jira Cloud site, follow these steps:
...
4. Search for **Hub** and click on the app item in the results list.
...
The global **Administer Jira** permission is required to install Hub. See the [Jira documentation](https://support.atlassian.com/jira-cloud-administration/docs/manage-global-permissions/) for details on how to setup the Administer Jira permission.
</NeutralCallout>

## Accessing Hub

Once installed, Hub can be accessed via the global **Apps** menu in the Jira navigation.

<Figure src="/media/hub/Apps%20Dropdown.png" alt="Access Hub via the Apps menu" caption="Access Hub via the Apps menu" />
...
It is typically related to either a missing or invalid payment method or an open quote (account in arrears). It's important to note that even though the Hub trial, as well as your Jira trial or plan, may be free, Atlassian requires a valid payment method on file to initiate trials of third-party apps.
