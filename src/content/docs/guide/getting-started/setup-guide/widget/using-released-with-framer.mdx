...
title: Using Released with Framer
space: hub
sidebar:
  order: 87
---
...
3. Customize the properties of the `<released-page>`tag at the bottom with your preferred values. For further details on the available options, refer to the [announcement-page.md](/guide/product/portals/portal/announcement-page/ "mention") documentation. 
