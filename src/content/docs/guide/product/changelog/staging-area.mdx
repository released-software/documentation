...
<Figure src="/media/hub/Filter.png" alt="ssue filter in the staging area" caption="ssue filter in the staging area" />
...
<LinkRow href="https://support.atlassian.com/jira-service-management-cloud/docs/use-advanced-search-with-jira-query-language-jql/" title="support.atlassian.com" />

<LinkRow href="https://www.atlassian.com/software/jira/guides/jql/cheat-sheet#advanced-search" title="www.atlassian.com" />
