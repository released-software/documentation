...
Hub currently supports videos from:
...
* Automatic Embedding
  * Once you paste the video URL, Hub will automatically detect the supported video platform and embed the video directly into your post.
