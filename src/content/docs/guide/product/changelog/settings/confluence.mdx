...
<Figure src="/media/hub/Confluence%20Setup.png" alt="Create a Confluence page to publish your posts" caption="Create a Confluence page to publish your posts" />
...
1.  Click the **Authenticate** button.
    ...
    Hub will ask for permission to view and update content in Confluence on your behalf.
...
<Figure src="/media/hub/Confluence%20Channel%20Page.png" alt="Confluence destination page." caption="Confluence destination page." />
