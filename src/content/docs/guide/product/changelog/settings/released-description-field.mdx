...
title: Changelog Description Field (optional)
space: hub
sidebar:
  order: 46
---
...
Hub AI-generates descriptions for your Jira tickets based on their title and internal description. By default, the description is stored in issue properties.
