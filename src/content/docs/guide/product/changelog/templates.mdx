...
**If the description is stored in a** [released-description-field.md](/guide/product/changelog/settings/released-description-field/ "mention"): Hub will use that description in the template and not generate a new description.
