...
<ResponsiveEmbed src="https://www.loom.com/share/224e1f1427d64cb1860af674e9d7f4c9?sid=2290b85f-f69c-492e-93ba-61752f948b61" title="Release Notes Template Demo" provider="loom" />
...
Aside from the above AI blocks, you can use most of the regular blocks available in the standard editor for templates as well. For more details, see the [editor](/guide/product/changelog/editor/ "mention") documentation.

<NeutralCallout type="caution" title="Images">

We currently do not support adding images in templates. However, you can add images once the post was generated. 
</NeutralCallout>

<Figure src="/media/hub/Announcement%20Page%20-%20Header.png" alt="Template Example" caption="Template Example" />
...
**If the description is stored in a** [released-description-field.md](/guide/product/changelog/settings/released-description-field/ "mention"): Released will use that description in the template and not generate a new description.
