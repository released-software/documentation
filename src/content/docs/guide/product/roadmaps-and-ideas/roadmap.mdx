...
Hub roadmaps support a variety of custom field types that can be displayed on the card or in the detail view.
...
The Public Description is a special Hub system field that can only be edited within a Hub board. It uses the same rich-text editor as the changelog, making it easy to embed images, videos, and other media (including YouTube and Loom).
...
To edit the public description, click any card in a Hub roadmap. You can edit the description inline — add text, images, or videos directly. See the [editor](/guide/product/changelog/editor/ "mention") documentation for details.
