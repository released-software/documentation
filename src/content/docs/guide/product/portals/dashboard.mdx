...
title: Dashboard
description: >-
  The Workspace Dashboard shows activity across your workspace. It includes view
  metrics, roadmap publishing history, and changelog posts. Use it to monitor
  engagement and keep track of what has been published.
space: hub
sidebar:
  order: 21
---
...
<Figure src="/media/hub/Dashboard-visibility.png" alt="Visibility &amp; Access" caption="Visibility &amp; Access" width={375} />
...
These indicators help you confirm how widely your updates are visible and whether the link is safe to share with external stakeholders. For more details, see the [access.md](/guide/product/portals/access/ "mention") settings. 
