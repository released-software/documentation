...
title: Custom Domain
description: >-
  By default, your Product Hub is accessible on a [subdomain].releasedhub.com
  domain.
space: hub
sidebar:
  order: 14
...
Those are the details you'll use to set your custom domain in your DNS provider. This is done _outside_ Hub, in the provider you are using for your domain.
...
Hub will automatically configure the SSL certificate for your domain.
