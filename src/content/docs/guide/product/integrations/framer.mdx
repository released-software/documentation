...
With **Hub + Framer**, you can seamlessly embed a widget or announcement page into your website.
...
Similar to the Page component, Hub provides a Badge component that you can copy and paste into your Framer design view.

```txt
https://framer.com/m/Hub-badge-UvAC.js@DtpmL9J2ZjCuvy77OuXw
```
