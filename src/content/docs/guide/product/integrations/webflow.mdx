...
With **Hub + Webflow**, you can seamlessly embed a widget or announcement page into your website.
...
## 1. Get the embed code from Hub

1. Follow the [installation instructions](/guide/product/portals/portal/announcement-page/#configuration) to get the embed code within Hub.
