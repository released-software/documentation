...
* Find the [**Channel ID**](/guide/resources/how-tos/finding-the-channel-id/) within the Released app in Jira. You can find the channel ID on the [**Page** Embed](/guide/product/portals/portal/announcement-page/) settings in your workspace
* Optionally configure additional settings

| Setting           | Description                                                                                       | Required          |
| ----------------- | ------------------------------------------------------------------------------------------------- | ----------------- |
| **Channel ID**    | Your Released channel identifier. [Learn more](/guide/resources/how-tos/finding-the-channel-id/) | ✅ Yes             |
...
To enable user verification for your Confluence macro you will require your Released **Account ID** and **Shared Secret** which can be found under [#credentials](/guide/product/administration/user-verification/#credentials "mention") within the **Released app in Jira.** 
...
* Add this domain to your [**Trusted Domains**](/guide/product/administration/trusted-domains/) in the Released app in Jira. 
