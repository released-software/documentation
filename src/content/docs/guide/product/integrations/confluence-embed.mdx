---
description: >-
  This guide will walk you through installing and configuring Hub Portals
  for Confluence.
title: Confluence Embed Macro
space: hub
sidebar:
  order: 56
---
...
This Confluence app works alongside the [Hub](https://marketplace.atlassian.com/apps/1230872/released-feedback-portal-public-roadmap-ai-release-notes?hosting=cloud\&tab=overview) app for Jira. To use it, Hub must be installed in Jira. The credentials below are generated and managed within the Jira app.
</NeutralCallout>
...
* You can start using the Hub Embed macro immediately
</li>
</ol>
</Steps>
...
* Navigate to the page where you want to embed your Hub portal
* Click **Edit** in the top right
</li>

<li>
### Insert the Hub Embed Macro

* Type `/` to open the quick insert menu
* Type "Hub" and select **Hub Embed** from the list
* Or use the toolbar: Click **+** → Search for "Hub Embed"
</li>
...
* Find the [**Channel ID**](/guide/resources/how-tos/finding-the-channel-id/) within the Hub app in Jira. You can find the channel ID on the [**Page** Embed](/guide/product/portals/portal/announcement-page/) settings in your workspace
* Optionally configure additional settings

| Setting           | Description                                                                                       | Required          |
| ----------------- | ------------------------------------------------------------------------------------------------- | ----------------- |
| **Channel ID**    | Your Hub channel identifier. [Learn more](/guide/resources/how-tos/finding-the-channel-id/) | ✅ Yes             |
...
* Your Hub portal is now live on the Confluence page
</li>
</ol>
</Steps>
...
To enable user verification for your Confluence macro you will require your Hub **Account ID** and **Shared Secret** which can be found under [#credentials](/guide/product/administration/user-verification/#credentials "mention") within the **Hub app in Jira.**
...
* **Account ID**: Paste your Hub account ID
...
* Add this domain to your [**Trusted Domains**](/guide/product/administration/trusted-domains/) in the Hub app in Jira.

📖 **Learn more:** [Trusted Domains Configuration](/guide/product/administration/trusted-domains/)
</li>
</ol>
</Steps>
...
1. **Automatic Authentication**
   * When a Confluence user views a page with the Hub macro, they're automatically authenticated
...
3. **Profile Sync**
   * User's Confluence display name and avatar are synced to Hub
...
2. **Check Trusted Domains**
   ...
   * Look for the warning: `[Hub] If the embed does not load...`
...
1. **Verify Credentials**
   * Go to Hub Portals global settings in Confluence
