---
description: Integrate Hub with Cosmos.
title: Cosmos
space: hub
sidebar:
  order: 61
...
* Select "Hub" from the list of available integrations.
</li>
...
New posts published to the [Announcement Page channel](/guide/product/changelog/publishing/#announcement-page) in Hub will now automatically appear on your Comos Dashboard.
