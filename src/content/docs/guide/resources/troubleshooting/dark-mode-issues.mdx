---
description: >-
  This page will help you troubleshoots an embedded page or widget that looks
  wrong when a user is using Dark Mode.
title: Dark Mode in the Released Page embed
space: hub
sidebar:
  order: 90
---
