...
\
If a Space is hidden from Hub using App Access rules, you won't be able to interact with it in Hub. Add Hub to your allowlist or remove it from your blocklist to use Hub with your protected Jira Spaces.
</NeutralCallout>
...
<table><thead><tr><th width="219">Permission</th><th>Required for</th></tr></thead><tbody><tr><td><strong>Administer Spaces</strong></td><td>Setting up the <strong>Changelog description</strong> custom field.</td></tr><tr><td><strong>Jira administrators</strong></td><td>Installing the Hub App.</td></tr></tbody></table>
