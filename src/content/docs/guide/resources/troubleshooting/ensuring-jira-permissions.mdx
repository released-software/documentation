...
<NeutralCallout type="caution" title="App Access Rules">
...
1. In the [Changelog description field](/guide/product/changelog/settings/released-description-field/), if the field is available on the issue type.
