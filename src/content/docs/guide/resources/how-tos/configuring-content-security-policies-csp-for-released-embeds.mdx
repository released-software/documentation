---
description: >-
  To embed Hub into your app while maintaining a secure Content Security
  Policy (CSP), you may need to adjust your existing policy to allow certain
  domains used by Hub.
title: Configuring Content Security Policies (CSP) for Hub Embeds
space: hub
sidebar:
  order: 78
---
...
When embedding Hub into your website or app, you may have to add to add Hub specific domains to your CSP policy.
...
At a minimum, the following CSP should work for most users embedding Hub:
...
This policy covers all potential subdomains of Hub, making it easier to accommodate updates or changes in our infrastructure without further adjustments.
...
For maximum flexibility and security, adopting the wildcard strategy (`*.released.so`) in your CSP will help avoid issues as Hub evolves. If you encounter specific errors, [contact our support team ](https://released.so/support)for further assistance.
