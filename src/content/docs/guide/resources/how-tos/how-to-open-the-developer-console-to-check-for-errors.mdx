---
title: How to Open the developer console to check for errors
description: >-
  If you encounter issues with viewing or interacting with web page elements
  like drop-down menus or buttons, we may ask you to check your browser's
  console for JavaScript errors. Use the following shortcuts to open the
