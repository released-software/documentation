---
title: Create Output in Other Languages
description: >-
  The AI models are optimized for use in English, but many of them are robust
  enough to generate good results for a variety of languages.\ \ We have seen
  good results in the following languages:
space: hub
sidebar:
  order: 65
---
...
4.  **Modify Prompt to output text in another language**\
    ...
    <Figure src="/media/hub/Language%20Prompt.png" alt="Language Prompt" />
