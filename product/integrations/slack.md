---
description: >-
  Released integrates with Slack in two ways: sharing product updates to Slack
  channels, and capturing Slack messages as feedback.
---
...
To get started, see [Sharing updates to Slack](../changelog/publishing-to-slack.md).
...
To get started, see [Slack feedback integration](../administration/slack.md).
