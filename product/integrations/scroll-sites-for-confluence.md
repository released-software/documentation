...
Released now integrates with Scroll Sites through their [custom JavaScript inject](http://help.k15t.com/scroll-sites/inject-custom-javascript) feature. Setting up this integration is a breeze and requires just a few simple steps, taking less than 5 minutes to complete.
