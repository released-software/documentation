...
* Use [templates](../../product/changelog/templates.md) for consistency.
* [Adjust the AI prompts](../../product/changelog/settings/artificial-intelligence.md) for each work item type to match the desired style.
